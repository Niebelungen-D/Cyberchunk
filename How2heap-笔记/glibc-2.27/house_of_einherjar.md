...
Our fake chunk at 0x7ffe5c40a220 looks like:
prev_size (not used): 0x100
size: 0x100
fwd: 0x7ffe5c40a220
bck: 0x7ffe5c40a220
fwd_nextsize: 0x7ffe5c40a220
bck_nextsize: 0x7ffe5c40a220
...
Our fake prev_size will be 0x55678c3b1290 - 0x7ffe5c40a220 = 0xffffd5692ffa7070

Modify fake chunk's size to reflect b's new prev_size
Now we free b and this will consolidate with our fake chunk since b prev_inuse is not set
Our fake chunk size is now 0xffffd5692ffc7de1 (b.size + fake_prev_size)

Now we can call malloc() and it will begin in our fake chunk
Next malloc(0x200) is at 0x7ffe5c40a230
```

**analysis**

在2.27中，该技术需要在关闭tcache使用或b的大小大于0x408时才能使用，tcache不存放large chunk。